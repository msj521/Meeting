...
<div class="x-body">
  ...
  <xblock>
    <button class="layui-btn" onclick="member_editf('增加会议日程','<?php echo (isset($edit) && ($edit !== '')?$edit:'/'); ?>','0','<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>','<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:0); ?>','')"><i class="layui-icon">&#xe608;</i>添加</button>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','/meet/time_agenda?fid=<?php echo $fid; ?>&convention_id=<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:0); ?>')"><i class="layui-icon">&#xe640;</i>批量删除</button> 
      ...
      <td class="td-manage" style="text-align: center">
        <span>
          <a title="编辑" href="javascript:;"
             onclick="member_editf('编辑会议日程','/meet/time_edit_agenda','<?php echo $vo['fid']; ?>','<?php echo (isset($fid) && ($fid !== '')?$fid:'0'); ?>','<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:'0'); ?>',0,0)"
             class="sp-10" style="text-decoration:none">
            <i class="layui-icon">&#xe642;</i>
          </a>
        </span>
        <span>
        <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/meet/time_del_agenda','/meet/time_agenda?fid=<?php echo $fid; ?>&convention_id=<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:0); ?>')"
...
<script>
  var room_id='<?php echo (isset($room_id) && ($room_id !== '')?$room_id:0); ?>';
  // 会议-编辑
