<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/wwwroot/default/SIFIC/public/../application/admin/view/menu/index.html";i:1540893659;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-nav">
  <span class="layui-breadcrumb">
    <a><cite>菜单管理</cite></a>
    <a><cite><?php echo (isset($title) && ($title !== '')?$title:"菜单列表"); ?></cite></a>
  </span>
...
<div class="x-body">
      ...
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <select name="app_type">
            ...
            <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $ko = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($ko % 2 );++$ko;?>
            <option value="<?php echo $ko; ?>"  <?php if($ko == $FType): ?> selected="selected" <?php endif; ?> ><?php echo $vo; ?></option>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td title="<?php echo $vo['app_type']; ?>"><?php echo app_type($vo['app_type']); ?></td>
      <td title="<?php echo $vo['route']; ?>"><?php echo (isset($vo['route']) && ($vo['route'] !== '')?$vo['route']:'父级菜单'); ?></td>
      <td title="<?php echo $vo['record_status']; ?>"><?php echo is_status($vo['record_status']); ?></td>
      <?php if(!empty(fid) and fid == 2): ?>
      <td class="td-manage">
              <a title="编辑" href="javascript:;" onclick="edit('编辑','/menu/edit','<?php echo $vo['fid']; ?>','500','500')"
                 class="ml-5" style="text-decoration:none" 
                >
                <i class="layui-icon" >&#xe642;</i>
              </a>

              <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/menu/del','/menu/index')"
