<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/home/wwwroot/default/SIFIC/public/../application/web/view/public/disclaimer.html";i:1539654598;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/header.html";i:1548638819;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/footer.html";i:1540200495;}*/ ?>
<!DOCTYPE html>
<html >
	<head>
		<meta charset="UTF-8">
...
<script>
	$(function(){
		...
		<div class="conter960">
			<div class="mbxue">
				位置&nbsp;>&nbsp;<span id="aboutlist"></span>
			</div>
			<div style="width: 100%; float: left;">
				<div class="ablist_nva">
					<a href="/about?sr=关于我们">关于我们</a>
					<a href="/copyright?sr=版权声明">版权声明</a>
					<a href="/disclaimer?sr=免责声明" class="action">免责声明</a>
					<a href="/report?sr=举报投诉">举报投诉</a>
					<a href="/contact?sr=联系我们">联系我们</a>
				</div>
				<div class="ablist_ct" id="ablist_ct">
	...
	$(function(){
		...
		function sys(data){
			if(data!=""||data!=null){
				...
				$("#ablist_ct").html(htmls(explaindata.disclaimer));
			}else{
