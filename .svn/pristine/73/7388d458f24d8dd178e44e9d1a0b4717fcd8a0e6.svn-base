<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"/home/wwwroot/default/SIFIC/public/../application/web/view/meeting/manual.html";i:1548211638;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/header.html";i:1546847820;s:66:"/home/wwwroot/default/SIFIC/application/web/view/public/mbxue.html";i:1545116695;s:72:"/home/wwwroot/default/SIFIC/application/web/view/public/meeting_nav.html";i:1542354791;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/footer.html";i:1540200495;}*/ ?>
<!DOCTYPE html>
<html >
	<head>
		<meta charset="UTF-8">
...
<script>
		...
		function mtdownload(data){
			...
			if(dow_data.length){
				...
				if(pdfurls.substr(-3,3)=="pdf"){
					$('<a href="'+pdfurls+'" target="view_window" download="'+pdfurls+'">'+download_title+'&nbsp;&nbsp;<span style="font-size:14px; color:#666">(点击下载文件)</span></a>').appendTo("#pdfname");
					createPdf(pdfurls)
				}else{
		...
		var data = {"convention_id":convention_id,"module":"B5"};
   		ajax_all_Filed("true", "true", "POST", download, "json", data, mtdownload);//调用函数
   		
 			function createPdf(pdfurls){new PDFObject({
				 url:pdfurls, //static/web/images/111.pdf
				 pdfOpenParams: { 
				      view: 'Fit', 
				      scrollbars: '0', 
				      toolbar: '0', 
