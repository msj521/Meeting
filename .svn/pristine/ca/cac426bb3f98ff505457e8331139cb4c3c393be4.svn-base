...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>产品管理</cite></a>
              <a><cite><?php echo (isset($title) && ($title !== '')?$title:'购买记录'); ?></cite></a>
            </span>
    ...
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="string" placeholder="产品名称/用户名" autocomplete="off" class="layui-input" value="<?php echo $string; ?>">
        </div>
