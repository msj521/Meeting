<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/default/SIFICYear/public/../application/admin/view/meet/edit_honor.html";i:1551844449;s:73:"/home/wwwroot/default/SIFICYear/application/admin/view/public/header.html";i:1548327812;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body layui-anim layui-anim-up">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <textarea placeholder="请输入内容" class="layui-textarea" type="text"  id="description" name="description"><?php echo (isset($honor['description']) && ($honor['description'] !== '')?$honor['description']:$list['description']); ?></textarea>
      </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input class="layui-input" id="sort" name="sort" value="<?php echo (isset($list['sort']) && ($list['sort'] !== '')?$list['sort']:0); ?>">
      </div>
    </div>
