...
<div class="x-body">
  <form class="layui-form x-center" action="/sys/partner" method="get">
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="string" value="<?php echo $string; ?>" placeholder="单位名称/电话/地址" autocomplete="off" class="layui-input">
        </div>
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edit('添加','/sys/partner/edit','/sys/partner','')"><i class="layui-icon">&#xe608;</i>添加</button>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'/sys/partner/delete','/sys/partner')"><i class="layui-icon">&#xe640;</i>批量删除</button> 
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td class="td-manage">
              ...
              <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/partner/edit','/sys/partner','<?php echo $vo['fid']; ?>',0,0)"
                 class="ml-5" style="text-decoration:none" 
                >
                <i class="layui-icon" >&#xe642;</i>
              </a>

              <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/partner/delete','/sys/partner')"
