<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/wwwroot/default/SIFIC/public/../application/admin/view/item/index.html";i:1537437005;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><?php echo $vo['class_name_zh']; ?></td>
      <td><?php echo get_class_type($vo['class_type']); ?></td>
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td><?php echo $vo['remark']; ?></td>
      <td><?php echo $vo['create_time']; ?></td>
      <td class="td-manage">
        <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/item/edit','/sys/item','<?php echo $vo['fid']; ?>',0,0)"
           class="ml-5" style="text-decoration:none">
          <i class="layui-icon" >&#xe642;</i>
        </a>
        <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/item/delete','/sys/item')"
