<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/wwwroot/default/SIFIC/public/../application/admin/view/meet/photo.html";i:1537437007;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <xblock>
    <button class="layui-btn layui-btn-danger" onclick="members_del(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>')"><i class="layui-icon">&#xe640;</i>批量审核</button> 
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><img src="<?php echo $vo['file_path']; ?>"></td>
      <td><?php echo $vo['class_name']; ?></td>
      <td><?php echo $vo['praise_num']; ?>&nbsp;&nbsp;<a href="javascript:;"  style="text-decoration:none;color:red" onclick="member_edit('点赞记录','/meet/photo_detail','/meet/photo',<?php echo $vo['fid']; ?>,0,0)" >点赞记录</a></td>
      <td><?php echo $vo['user_name']; ?></td>
      <td><?php echo $vo['create_time']; ?></td>
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td class="td-manage"> 
        <a title="禁用" href="javascript:;" onclick="members_del('<?php echo $vo['fid']; ?>','<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>','<?php echo $vo['record_status']; ?>')"
...
<script>
  function members_del(id, url, urls,record_status) {
    if (id == -1) {
      var ids = tableCheck.getData();
    } else {
      var ids = id;
    ...
    if (ids == '' || ids == null || ids < 0) {
      ...
      layer.confirm('确认状态操作？', {
        ...
        iss_del(ids,url,urls,record_status);
      }, function(){
        window.location.href = urls;
      });
    }
  ...
  function iss_del(ids,url,urls,type){
    //发异步删除数据
    $.ajax({
      type: "post",
      url: url,
