...
<div class="x-body">
  <form class="layui-form x-center" action="<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>" method="get">
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        ...
        <input type="hidden" name="video_id" value="<?php echo (isset($video_id) && ($video_id !== '')?$video_id:0); ?>">
  ...
  <xblock>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo $video_id; ?>')"><i class="layui-icon">&#xe640;</i>批量删除</button> 
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><?php echo $vo['cur_duration']; ?></td>
      <td><?php echo $vo['playback_position']; ?></td>
      <td><?php echo is_no($vo['play_finish']); ?></td>
      <td><?php echo $vo['create_time']; ?></td>      
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td class="td-manage">
        <a title="删除" href="javascript:;" onclick="member_del(<?php echo $vo['fid']; ?>,'<?php echo (isset($del) && ($del !== '')?$del:"/"); ?>','<?php echo (isset($index) && ($index !== '')?$index:"/"); ?>?fid=<?php echo $vo['video_id']; ?>')" style="text-decoration:none">
