<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/default/SIFICYear/public/../application/admin/view/meet/switch.html";i:1548224286;s:73:"/home/wwwroot/default/SIFICYear/application/admin/view/public/header.html";i:1548327812;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <form class="layui-form" action="<?php echo $update; ?>" method="post" enctype="multipart/form-data">
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input class="layui-input" disabled='disabled'  value="<?php echo (isset($list['convention_name']) && ($list['convention_name'] !== '')?$list['convention_name']:''); ?>">
      </div>
    </div>
    <div class="layui-form-item">
      <label  class="layui-form-label"><?php echo (isset($theme) && ($theme !== '')?$theme:''); ?></label>
      <div class="layui-input-block">
        <script id="editor" type="text/plain" name="<?php echo (isset($field) && ($field !== '')?$field:''); ?>" required></script>
      </div>
    </div>
    <input type="hidden" name="convention_id" value="<?php echo (isset($list['fid']) && ($list['fid'] !== '')?$list['fid']:0); ?>">
    <input type="hidden" name="article_type" value="<?php echo (isset($article_type) && ($article_type !== '')?$article_type:0); ?>">
