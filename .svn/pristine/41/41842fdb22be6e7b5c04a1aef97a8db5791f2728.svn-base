<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/home/wwwroot/default/SIFIC/public/../application/admin/view/product/section.html";i:1537860811;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>产品管理</cite></a>
              <a><cite><?php echo (isset($title) && ($title !== '')?$title:'培训课程'); ?></cite></a>
            </span>
    ...
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="string" placeholder="产品名称/章节标题" autocomplete="off" class="layui-input" value="<?php echo $string; ?>">
        </div>
...
<!--     <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>')"><i class="layui-icon">&#xe640;</i>批量删除</button> -->
    ...
    <a class="layui-btn" ><span class="x-right" style="line-height:40px">共有数据：<?php echo $cnt; ?> 条</span></a>
  </xblock>
