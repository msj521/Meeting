<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/home/wwwroot/default/SIFIC/public/../application/admin/view/meet/exh.html";i:1542597943;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <div class="layui-row">
    ...
    <div class="layui-col-xs6">
      <form class="layui-form x-center" action="<?php echo $index; ?>" method="get">
      ...
      <table class="layui-table">
        ...
        <tbody>
        <?php if(is_array($exhibitor) || $exhibitor instanceof \think\Collection || $exhibitor instanceof \think\Paginator): $i = 0; $__LIST__ = $exhibitor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
          <td><?php echo $vo['fid']; ?></td>
          <td title="<?php echo $vo['org_name']; ?>"><?php echo $vo['org_name']; ?></td>
          <td class="td-manage" style="text-align: center">
            <span style="margin-right: 25px">
              <a title="添加" href="javascript:;"onclick="member_edits('增加企业','<?php echo $edit; ?>','<?php echo $index; ?>','<?php echo $vo['fid']; ?>','<?php echo $convention_id; ?>',0,400,300)"
                 class="sp-10 layui-btn" style="text-decoration:none">
                <i class="iconfont">&#xe6b9;</i>
              </a>
            </span>
          </td>
    ...
    <div class="layui-col-xs6">
      <form class="layui-form x-center" action="<?php echo $index; ?>" method="get">
        <div class="layui-form-pane" style="text-align: center;">
          <div class="layui-form-item">
            <label class="layui-form-label">企业</label>
            <div class="layui-input-inline">
              <input type="text" name="exh" value="<?php echo $exh; ?>" placeholder="请输入查询内容" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-input-inline" style="width:80px">
              <button class="layui-btn" lay-submit="" lay-filter="sreach"><i class="layui-icon">&#xe615;</i></button>
            </div>
            ...
            <div class="layui-input-inline" style="Float:right">
              <a class="layui-btn layui-btn-danger" onclick='member_dels(-1,"del_exh","/meet/exh?convention_id=<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:0); ?>")'><i class="layui-icon"></i>批量删除</a>
            </div>
          </div>
        </div>
      </form>
      <table class="layui-table">
        ...
        <tr>
          ...
          <td title="<?php echo $vo['fid']; ?>"><?php echo $vo['fid']; ?></td>
          <td title="<?php echo $vo['org_name']; ?>"><?php echo $vo['org_name']; ?></td>
          <td title="<?php echo $vo['booth']; ?>"><?php echo $vo['booth']; ?></td>
          <td><?php echo exhibitor_type($vo['exhibitor_type']); ?></td>
