<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/home/wwwroot/default/SIFIC/public/../application/admin/view/org/edit.html";i:1547782554;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1542434096;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
    ...
    <div class="x-body layui-anim layui-anim-up">
        <!-- 右侧内容框架，更改从这里开始 -->
        <form class="layui-form"  action="/sys/org/update" method="post" enctype="multipart/form-data">
            ...
            <div class="layui-form-item">
              <label for="web_url" class="layui-form-label">官网</label>
              <div class="layui-input-block">
