<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/home/wwwroot/default/SIFIC/public/../application/admin/view/meet/notice.html";i:1537437007;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1542434096;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1539320918;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edits('添加','<?php echo (isset($edit) && ($edit !== '')?$edit:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>','','<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:'0'); ?>','')"><i class="layui-icon">&#xe608;</i>添加</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><a href="<?php echo $vo['path_url']; ?>" target="_blank" style="text-decoration:none;color:red"><?php echo $vo['path_url']; ?></a></td>
      <td><a href="javascript:;"  style="text-decoration:none;color:red" onclick="member_edit('阅读记录','/meet/notice_detail','/meet/notice',<?php echo $vo['fid']; ?>,0,0)" >查看记录</a></td>
