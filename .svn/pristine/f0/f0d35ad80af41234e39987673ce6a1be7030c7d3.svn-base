<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/home/wwwroot/default/SIFIC/public/../application/web/view/public/copyright.html";i:1539654598;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/header.html";i:1548638819;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/footer.html";i:1540200495;}*/ ?>
<!DOCTYPE html>
<html >
	<head>
		<meta charset="UTF-8">
		...
		<div class="conter960">
			...
			<div style="width: 100%; float: left;">
				<div class="ablist_nva">
					...
					<a href="/copyright?sr=版权声明" class="action">版权声明</a>
	...
	$(function(){
		...
		function sys(data){
			if(data!=""||data!=null){
				...
				$("#ablist_ct").html(htmls(explaindata.statement));
			}else{
