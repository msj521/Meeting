<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/wwwroot/default/SIFIC/public/../application/admin/view/live/index.html";i:1540283746;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>直播管理</cite></a>
              <a><cite><?php echo (isset($title) && ($title !== '')?$title:'直播列表'); ?></cite></a>
            </span>
  ...
  layui.use(['table','layer'],function(){
    ...
    table.render({
      ...
      ,cols: [[
        ...
        ,{field:'start_date', width:160, title: '开始时间'}
        ,{field:'end_date',  width:160, title: '结束时间'}
        ,{field:'play_count',  title: '播放量'}
        ,{field:'record_status',  title: '状态'}
        ,{field:'recommend',  title: '推荐'}
        ,{field:'barrage_show',  title: '开启弹幕'}
        ,{field:'sort',  title: '置顶'}
        ,{field:'refresh_time',  width: 160,title: '通信刷新(秒)'}
        ,{fixed: 'right',  align:'center', toolbar: '#barTool'}
      ]]
      ,page: false
