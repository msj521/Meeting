...
<div class="x-body">
  ...
  <xblock>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&J=0')"><i class="layui-icon">&#xe640;</i>批量删除</button>
    <button class="layui-btn" onclick="member_check(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&J=0')"><i class="layui-icon">&#xe6b2;</i>批量审核</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><a href="javascript:;"  style="text-decoration:none;color:red" onclick="member_edit('回复记录','/meet/podcast_comment','/meet/podcast?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&J=0',<?php echo $vo['fid']; ?>,0,0)" >回复记录</a></td>
      <td><?php echo $vo['content']; ?></td>
      <td><img src="<?php echo $vo['image_ids']; ?>"></td>
      <td><?php echo $vo['create_time']; ?></td>
      <td><?php echo check_status($vo['check']); ?></td>
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td class="td-manage"> 
        <a title="删除" href="javascript:;" onclick="member_del(<?php echo $vo['fid']; ?>,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&J=0')" style="text-decoration:none">
          <i class="layui-icon">&#xe640;</i>
        </a>

        <a title="审核" href="javascript:;" onclick="member_check(<?php echo $vo['fid']; ?>,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&J=0')" style="text-decoration:none">
          <i class="layui-icon">&#xe6b2;</i>
        </a>
      </td>      
    </tr>
