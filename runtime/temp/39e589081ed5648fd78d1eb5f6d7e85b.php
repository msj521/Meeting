<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/default/SIFIC/public/../application/admin/view/log/log_app.html";i:1537437006;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  <form class="layui-form x-center" action="/sys/log_app" method="get">
...
<!--       <td>
      ...
      <td><?php echo $vo['op_time']; ?></td>
      <td><?php echo $vo['op_elapse']; ?></td>
      <td><?php echo $vo['op_func']; ?></td>
      <td><?php echo $vo['cpu']; ?></td>
      <td><?php echo $vo['memory_free']; ?></td>
      <td><?php echo $vo['memeory_total']; ?></td>
      <td><?php echo $vo['flash_free']; ?></td>
      <td><?php echo $vo['flash_total']; ?></td>
