<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/home/wwwroot/default/SIFIC/public/../application/admin/view/meet/agenda.html";i:1538028321;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  <form class="layui-form x-center" action="/meet/agenda" method="get">
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        ...
        <div class="layui-input-inline">
          <input class="layui-input" placeholder="截止日" id="LAY_demorange_e" name="end_time" value="<?php echo $end; ?>">
        </div>

        <div class="layui-input-inline">
          <input type="text" name="string" value="<?php echo $string; ?>" placeholder="请输入查询内容" autocomplete="off"
                 class="layui-input">
        </div>
  ...
  <table class="layui-table">
    ...
    <tr>
      <td>
        <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo $vo['fid']; ?>'><i class="layui-icon">
          &#xe605;</i></div>
      </td>
      <td><?php echo $vo['fid']; ?></td>
      <td title="<?php echo $vo['schedule_name']; ?>"><?php echo $vo['schedule_name']; ?></td>
      <td title="<?php echo $vo['room_name']; ?>"><?php echo $vo['room_name']; ?></td>
      <td title="<?php echo $vo['expert_name']; ?>"><?php echo $vo['expert_name']; ?></td>
      <td title="<?php echo $vo['start_date']; ?>"><?php echo $vo['start_date']; ?></td>
      <td title="<?php echo $vo['end_date']; ?>"><?php echo $vo['end_date']; ?></td>
      <td style="text-align: center">
        <a href="javascript:;" onclick="member_edits('时间日程','/meet/time_agenda','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>','<?php echo $vo['fid']; ?>','<?php echo (isset($vo['convention_id']) && ($vo['convention_id'] !== '')?$vo['convention_id']:0); ?>','<?php echo (isset($vo['room_id']) && ($vo['room_id'] !== '')?$vo['room_id']:0); ?>')"
      ...
      <td class="td-manage">
              <a title="编辑" href="javascript:;" onclick="member_edits('编辑','<?php echo (isset($edit) && ($edit !== '')?$edit:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>','<?php echo $vo['fid']; ?>','<?php echo (isset($vo['convention_id']) && ($vo['convention_id'] !== '')?$vo['convention_id']:0); ?>','')"
                 class="ml-5" style="text-decoration:none" >
