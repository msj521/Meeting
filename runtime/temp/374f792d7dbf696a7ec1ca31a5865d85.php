<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/home/wwwroot/default/SIFIC/public/../application/web/view/user/index.html";i:1547453936;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/header.html";i:1548638819;s:67:"/home/wwwroot/default/SIFIC/application/web/view/public/footer.html";i:1540200495;}*/ ?>
<!DOCTYPE html>
<html >
	<head>
		<meta charset="UTF-8">
					...
					<div class="usrinfo_txt">
						<ul class="usrinfo_txt_ul">
							<li class="userli01">
								...
								<div class="usrinfo_txtct" id="user_name"></div>
								
							</li>
							<li class="userli01">
								<div class="usrinfo_txtlf">手机号：</div>
								<div class="usrinfo_txtct" id="tel"></div>
								
							</li>
							<li class="userli01">
								<div class="usrinfo_txtlf">职位：</div>
								<div class="usrinfo_txtct" id="job_name"></div>
								
							</li>
							
							<li class="userli01">
								<div class="usrinfo_txtlf">学历：</div>
								<div class="usrinfo_txtct" id="education_name"></div>
								
							</li>
							<li class="userli02">
								<div class="usrinfo_txtlf">科室/部门：</div>
								<div class="usrinfo_txtct" id="department"></div>
								
							</li>
							<li class="userli02">
								<div class="usrinfo_txtlf">所属单位：</div>
								<div class="usrinfo_txtct ellipsis" id="org_name" title=""></div>
							</li>
