...
<body>
  ...
  <div class="x-body">
    <form class="layui-form x-center" action="/sys/source" method="get">
      <div class="layui-form-pane" style="text-align: center;">
        <div class="layui-form-item" style="display: inline-block;">
          <div class="layui-input-inline">
            <select name="source_type_id" lay-search="">
              <option value="">资源类型</option>
              <?php if(is_array($source_type) || $source_type instanceof \think\Collection || $source_type instanceof \think\Paginator): $ko = 0; $__LIST__ = $source_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($ko % 2 );++$ko;?>
              <option value="<?php echo $ko; ?>" <?php if($ko == $source_type_id): ?> selected="selected" <?php endif; ?>><?php echo $vo; ?> </option>
                <?php endforeach; endif; else: echo "" ;endif; ?> </select> </div> <div class="layui-input-inline">
    ...
    <xblock>
      <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'/sys/source/delete','/sys/source')"><i class="layui-icon">&#xe640;</i>批量删除</button>
    ...
    <table class="layui-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td title="<?php echo $vo['file_path']; ?>"><?php echo $vo['file_path']; ?></td>
          <td><?php echo $vo['file_size']; ?>kb</td>
          <td><?php echo source_type($vo['source_type']); ?></td>
          <td>
            <a target="_black" href="<?php echo $vo['file_path']; ?>">
              <?php if($vo['source_type'] == 1): ?>
                <image src="<?php echo $vo['file_path']; ?>">
              <?php elseif($vo['source_type'] == 2): ?>
                <i class="iconfont">&#xe6da;</i>
              <?php elseif($vo['source_type'] == 3): ?>
                <i class="iconfont">&#xe6bc;</i>
              <?php elseif($vo['source_type'] == 4): ?>
                <i class="iconfont">&#xe740;</i>
              <?php else: ?>
                其他
              <?php endif; ?>
          ...
          <td class="td-manage">
            <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/source/edit','/sys/source','<?php echo $vo['fid']; ?>',480,350)"
              class="ml-5" style="text-decoration:none">
              <i class="layui-icon">&#xe642;</i>
            </a>
            <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/source/delete','/sys/source')"
