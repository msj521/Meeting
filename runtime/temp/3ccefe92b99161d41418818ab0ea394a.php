<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/default/SIFIC/public/../application/admin/view/meet/edit_notice.html";i:1547779940;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1542434096;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body layui-anim layui-anim-up">
  <form class="layui-form" action="<?php echo (isset($update) && ($update !== '')?$update:'/'); ?>"  method="post" enctype="multipart/form-data">
    ...
    <div class="layui-form-item">
      <label for="path_url" class="layui-form-label">跳转地址</label>
      <div class="layui-input-block">
        <input class="layui-input" id="path_url" name="path_url" required lay-verify="path_url"  value="<?php echo (isset($list['path_url']) && ($list['path_url'] !== '')?$list['path_url']:''); ?>">
      </div>
    </div>
