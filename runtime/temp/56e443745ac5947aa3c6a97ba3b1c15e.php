<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/default/SIFIC/public/../application/admin/view/partner/edit.html";i:1547781931;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1542434096;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
    ...
    <div class="x-body layui-anim layui-anim-up">
        <!-- 右侧内容框架，更改从这里开始 -->
        <form class="layui-form"  action="/sys/partner/update" method="post" enctype="multipart/form-data">
            <div class="layui-form-item">
              <label for="org_name" class="layui-form-label">单位机构<?php html_sign();?></label>
            ...
            <div class="layui-form-item">
              <label for="address" class="layui-form-label">单位地址<?php html_sign();?></label>
              <div class="layui-input-block">
            ...
            <div class="layui-form-item">
              <label for="tel" class="layui-form-label">电话<?php html_sign();?></label>
              <div class="layui-input-block">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
              <label class="layui-form-label">公司图片<?php html_sign();?></label>
