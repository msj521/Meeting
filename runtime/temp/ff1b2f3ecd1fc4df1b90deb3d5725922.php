<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/home/wwwroot/default/SIFIC/public/../application/admin/view/exam/result.html";i:1537860573;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>考试管理</cite></a>
              <a><cite><?php echo (isset($title) && ($title !== '')?$title:'成绩单'); ?></cite></a>
            </span>
...
<div class="x-body">
    ...
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="string" placeholder="用户名称" autocomplete="off" class="layui-input" value="<?php echo $string; ?>">
        </div>
  ...
  <xblock>
  <xblock>
    <a><span class="layui-btn" style="line-height:40px">共有数据：<?php echo $cnt; ?> 条</span></a>
  </xblock>
  ...
  layui.use(['table','layer'],function(){
    ...
    table.on('tool(tableTool)', function(obj){
      ...
      if(obj.event === 'del'){
        ...
        section_edit('答题记录','/exam/record','<?php echo (isset($index) && ($index !== '')?$index:"/"); ?>',data.fid,data.exam_id,data.creator_id,0,0)
      } 
    });
  })
