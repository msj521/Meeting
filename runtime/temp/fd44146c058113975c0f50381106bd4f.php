<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/home/wwwroot/default/SIFIC/public/../application/admin/view/meet/sign.html";i:1541208870;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>会议管理</cite></a>
              <a><cite><?php echo (isset($title) && ($title !== '')?$title:'会议报名'); ?></cite></a>
            </span>
...
<div class="x-body">
    ...
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="string" placeholder="字段名称" autocomplete="off" class="layui-input" value="<?php echo $string; ?>">
        </div>
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edit('添加','<?php echo (isset($edit) && ($edit !== '')?$edit:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&ZS=0','<?php echo (isset($convention_id) && ($convention_id !== '')?$convention_id:0); ?>')"><i class="layui-icon">&#xe608;</i>添加</button>
...
<script>
  ...
  layui.use(['table','layer'],function(){
    ...
    table.on('tool(tableTool)', function(obj){
      var data = obj.data;
      if(obj.event === 'del'){
        member_del(data.fid,'<?php echo (isset($del) && ($del !== '')?$del:"/"); ?>','<?php echo (isset($index) && ($index !== '')?$index:"/"); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>')
      } else if(obj.event === 'edit'){
        member_edit('编辑',"<?php echo (isset($edit) && ($edit !== '')?$edit:'/'); ?>?convention_id=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&fid="+ data.fid,"<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>?fid=<?php echo (isset($fid) && ($fid !== '')?$fid:0); ?>&ZS=0",data.fid,0)
      }
    });
  })   
</script>
