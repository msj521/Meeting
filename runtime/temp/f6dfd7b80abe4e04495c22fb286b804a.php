<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/home/wwwroot/default/SIFIC/public/../application/admin/view/exam/subject_edit.html";i:1547782668;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1542434096;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1539320918;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <form class="layui-form"  action="<?php echo (isset($update) && ($update !== '')?$update:'/'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="text" id="subject_name" lay-verify="required" name="subject_name" autocomplete="off" value="<?php echo (isset($list['subject_name']) && ($list['subject_name'] !== '')?$list['subject_name']:''); ?>" class="layui-input">
              </div>
            </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                ...
                <input type="radio" name="subject_type" value="2" title="多选题" <?php if(isset($list['subject_type']) and $list['subject_type'] == 2): ?> checked <?php endif; ?>>
                <input type="radio" name="subject_type" value="3" title="判断题" <?php if(isset($list['subject_type']) and  $list['subject_type'] == 3): ?> checked <?php endif; ?>>
              </div>
            </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="number" id="score" name="score" autocomplete="off" lay-verify="required" value="<?php echo (isset($list['score']) && ($list['score'] !== '')?$list['score']:''); ?>" class="layui-input">
              </div>
            </div>
            ...
            <input type="hidden" name="exam_id" value="<?php echo (isset($list['exam_id']) && ($list['exam_id'] !== '')?$list['exam_id']:$exam_id); ?>">
