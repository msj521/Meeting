<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/wwwroot/default/SIFIC/public/../application/admin/view/user/index.html";i:1542813530;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
 <!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
    ...
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="user_name" value="<?php echo $user_name; ?>" placeholder="用户名,姓名,电话或机构" autocomplete="off" class="layui-input">
        </div>
  ...
  <xblock>
               ...
               <button class="layui-btn" onclick="member_add('用户新增','<?php echo $edit; ?>','','')"><i class="layui-icon">&#xe608;</i>添加</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td >
        <?php if($vo['prohibit_status'] == 1): ?>
        <span style="color: #4ae18e; margin-right: 25px;">正常</span>
        <a href="javascript:;" class="layui-btn layui-btn-primary" onclick="prohibit_status('<?php echo $vo['fid']; ?>',2)" class="ml-5" style="color: #e1504a;text-decoration:none">禁言</a>
        <?php elseif($vo['prohibit_status'] == 2): ?>
          <span style="color: #e1504a;margin-right: 25px;">禁言</span>
        <a  href="javascript:;" class="layui-btn layui-btn-primary" onclick="prohibit_status('<?php echo $vo['fid']; ?>',1)" class="ml-5" style="color: #4ae18e;text-decoration:none">恢复</a>
        <?php endif; ?>
      </td>
      <td ><?php echo is_status($vo['record_status']); ?></td>
      <td class="td-manage">
          <a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo $edit; ?>','<?php echo $index; ?>','<?php echo $vo['fid']; ?>','','')"
             class="ml-5" style="text-decoration:none"><i class="layui-icon" >&#xe642;</i>
          </a>
          <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','<?php echo $del; ?>','<?php echo $index; ?>')"
