<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/wwwroot/default/SIFIC/public/../application/admin/view/exam/index.html";i:1537860561;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-nav">
            <span class="layui-breadcrumb">
              <a><cite>考试管理</cite></a>
              <a><cite><?php echo (isset($title) && ($title !== '')?$title:'考试列表'); ?></cite></a>
            </span>
    ...
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <input type="text" name="string" placeholder="考试名称/考试描述" autocomplete="off" class="layui-input" value="<?php echo $string; ?>">
        </div>
...
<script>
  ...
  for (var i = 0; i < dataList.data.length; i++) {
    ...
    dataList.data[i].show_analysis = dataList.data[i].show_analysis==1 ? '是' : '否';
  ...
  layui.use(['table','layer'],function(){
    ...
    table.on('tool(tableTool)', function(obj){
      ...
      if(obj.event === 'del'){
        ...
        member_edit('考试题目','/exam/subject','<?php echo (isset($index) && ($index !== '')?$index:"/"); ?>',data.fid,0,0)
      } else if(obj.event === 'B'){
        member_edit('成绩单','/exam/result','<?php echo (isset($index) && ($index !== '')?$index:"/"); ?>',data.fid,0,0)
      }
    });
  })
</script>
