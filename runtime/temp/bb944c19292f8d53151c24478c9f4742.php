...
<div class="x-body">
  <form class="layui-form x-center" action="/sys/version" method="get">
    <div class="layui-form-pane" style="text-align: center;">
      <div class="layui-form-item" style="display: inline-block;">
        <div class="layui-input-inline">
          <select name="sys_type_id" lay-search="" >
            ...
            <option value="<?php echo $ko; ?>"  <?php if($ko == $sys_type_id): ?> selected="selected" <?php endif; ?> ><?php echo $vo; ?></option>
        ...
        <div class="layui-input-inline">
          <input type="text" name="string" value="<?php echo $string; ?>" placeholder="版本号/版本说明" autocomplete="off" class="layui-input">
        </div>
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edit('添加','/sys/version/edit','/sys/version','')"><i class="layui-icon">&#xe608;</i>添加</button>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'/sys/version/delete','/sys/version')"><i class="layui-icon">&#xe640;</i>批量删除</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><?php echo sys_type($vo['app_postfix']); ?></td>
      <td><?php echo $vo['version_no']; ?></td>
      <td><?php echo $vo['release_time']; ?></td>
      <td><?php echo $vo['memo']; ?></td>
      <td><?php echo $vo['dl_num']; ?></td>
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td><?php echo $vo['create_time']; ?></td>
      <td class="td-manage">
        <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/version/edit','/sys/version','<?php echo $vo['fid']; ?>',0,0)"
           class="ml-5" style="text-decoration:none">
          <i class="layui-icon" >&#xe642;</i>
        </a>
        <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/version/delete','/sys/version')"
