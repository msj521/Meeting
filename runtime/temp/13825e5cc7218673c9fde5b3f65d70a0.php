...
<div class="x-body">
  <form class="layui-form x-center" action="/sys/hospital" method="get">
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edit('添加','/sys/hospital/edit','/sys/hospital','')"><i class="layui-icon">&#xe608;</i>添加</button>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'/sys/hospital/delete','/sys/hospital')"><i class="layui-icon">&#xe640;</i>批量删除</button> 
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td class="td-manage">
              ...
              <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/hospital/edit','/sys/hospital','<?php echo $vo['fid']; ?>',0,0)"
                 class="ml-5" style="text-decoration:none" 
                >
                <i class="layui-icon" >&#xe642;</i>
              </a>

              <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/hospital/delete','/sys/hospital')"
