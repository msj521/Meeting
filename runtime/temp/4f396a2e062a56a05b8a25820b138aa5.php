...
<div class="x-body">
  <form class="layui-form x-center" action="/sys/expert/index" method="get">
...
<!--        <div class="layui-input-inline">
          <select name="class_type" lay-search="" >
            ...
            <option value="<?php echo $ko; ?>"  <?php if($ko == $class_type): ?> selected="selected" <?php endif; ?> ><?php echo $vo; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
          </select>
        </div>-->
        <div class="layui-input-inline">
          <input type="text" name="string" value="<?php echo $string; ?>" placeholder="姓名/履历/介绍/擅长领域" autocomplete="off" class="layui-input">
        </div>
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edit('添加','/sys/expert/edit','/sys/expert/index','')"><i class="layui-icon">&#xe608;</i>添加</button>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'/sys/expert/delete','/sys/expert/index')"><i class="layui-icon">&#xe640;</i>批量删除</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><?php echo $vo['expert_name']; ?></td>
      <td><?php echo $vo['experience']; ?></td>
      <td><?php echo $vo['research_fields']; ?></td>
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td><?php echo $vo['create_time']; ?></td>
      <td class="td-manage">
        <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/expert/edit','/sys/expert/index','<?php echo $vo['fid']; ?>',0,0)"
           class="ml-5" style="text-decoration:none">
          <i class="layui-icon" >&#xe642;</i>
        </a>
        <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/expert/delete','/sys/expert/index')"
