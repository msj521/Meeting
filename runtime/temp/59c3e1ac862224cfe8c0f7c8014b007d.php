<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/home/wwwroot/default/SIFIC/public/../application/admin/view/version/version_up.html";i:1537435240;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/header.html";i:1548327812;s:69:"/home/wwwroot/default/SIFIC/application/admin/view/public/top_js.html";i:1548124979;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body">
  <form class="layui-form x-center" action="/sys/version_up" method="get">
    <div class="layui-form-pane" style="text-align: center;">
        <div class="layui-input-inline">
          <input type="text" name="string" value="<?php echo $string; ?>" placeholder="版本号/机构单位/用户名" autocomplete="off" class="layui-input">
        </div>
  ...
  <xblock>
    <button class="layui-btn" onclick="member_edit('添加','/sys/version_up/edit','/sys/version_up','')"><i class="layui-icon">&#xe608;</i>添加</button>
    <button class="layui-btn layui-btn-danger" onclick="member_del(-1,'/sys/version_up/delete','/sys/version_up')"><i class="layui-icon">&#xe640;</i>批量删除</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td><?php echo version_up_type($vo['force_type']); ?></td>
      <td><?php echo $vo['xor']; ?></td>
      <td><?php echo $vo['start_time']; ?></td>
      <td><?php echo $vo['end_time']; ?></td>
      <td><?php echo is_status($vo['record_status']); ?></td>
      <td class="td-manage">
        <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/sys/version_up/edit','/sys/version_up','<?php echo $vo['fid']; ?>',0,0)"
           class="ml-5" style="text-decoration:none">
          <i class="layui-icon" >&#xe642;</i>
        </a>
        <a title="删除" href="javascript:;" onclick="member_del('<?php echo $vo['fid']; ?>','/sys/version_up/delete','/sys/version_up')"
