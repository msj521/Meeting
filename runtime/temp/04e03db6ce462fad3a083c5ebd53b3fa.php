...
<div class="x-body">
  ...
  <xblock>
    ...
    <button class="layui-btn" onclick="member_check(-1,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>')"><i class="layui-icon">&#xe6b2;</i>批量审核</button>
  ...
  <table class="layui-table">
    ...
    <tr>
      ...
      <td>
        <a title="点赞记录" href="javascript:;" onclick="member_edit('点赞记录','/live/video_praise','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>',<?php echo $vo['fid']; ?>,0,0)" style="text-decoration:none">
          <i class="iconfont">&#xe717;</i>
        </a>
      </td>
      <td class="td-manage">
        <a title="删除" href="javascript:;" onclick="member_del(<?php echo $vo['fid']; ?>,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>')" style="text-decoration:none">
          <i class="layui-icon">&#xe640;</i>
        </a>

        <a title="审核" href="javascript:;" onclick="member_check(<?php echo $vo['fid']; ?>,'<?php echo (isset($del) && ($del !== '')?$del:'/'); ?>','<?php echo (isset($index) && ($index !== '')?$index:'/'); ?>')" style="text-decoration:none">
          <i class="layui-icon">&#xe6b2;</i>
        </a>
      </td>
    </tr>
